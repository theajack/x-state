(function (factory) {
  ...
  function pad(num, maxLength) {
    return repeat$2('0', maxLength - num.toString().length) + num;
  }
  ...
  function warn$3(text) {
    console.warn(text);
  }

  function mapData(xstate, data, name) {
    var newCommit = {};

    var _loop = function _loop(k) {
      newCommit[k] = function () {
        var _data$k;
        ...
        return (_data$k = data[k]).call.apply(_data$k, [xstate].concat(payloads));
      };
    };
  ...
  function mapGetter(xstate, getters, state) {
    var properties = {};
  ...
  function mapState$1(xstate, state) {
    var properties = {};
  ...
  var script = {
    ...
    methods: {
      add: function add() {
        data.a += 1;
        store.commit.addA(); // vxstore.state.a += 1;
        // this.$forceUpdate();
      }
    },
    mounted: function mounted() {}
  ...
  function main() {
    ...
    window.store = store; // window.Main = Main;
  }
